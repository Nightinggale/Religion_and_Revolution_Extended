...
void CyEnumsPythonInterface()
{
	...
	python::enum_<DiploEventTypes>("DiploEventTypes")
		...
		.value("DIPLOEVENT_ACQUIRE_NATIVE_SLAVE", DIPLOEVENT_ACQUIRE_NATIVE_SLAVE) // R&R, ray, Native Slave, START
		.value("DIPLOEVENT_ACQUIRE_AFRICAN_SLAVES", DIPLOEVENT_ACQUIRE_AFRICAN_SLAVES) // R&R, ray, African Slaves - START
		...
		.value("DIPLOEVENT_NATIVE_TRADE", DIPLOEVENT_NATIVE_TRADE) // R&R, ray, Natives Trading - START
