...
void CvGlobals::cacheGlobals()
{
	...
	// New Rules for Profession Missionary
	m_USE_NEW_RULES_FOR_PROFESSION_MISSIONARY = getDefineINT("USE_NEW_RULES_FOR_PROFESSION_MISSIONARY");
	// R&R, ray, caching globals from Global Defines Alt - END
}
...
int CvGlobals::getNEW_CAPACITY()			//VET NewCapacity - 3/3
{
	return m_iNEW_CAPACITY;
}				

// TAC - AI Improved Navel AI - koma13 - START
int CvGlobals::getAI_TRANSPORT_DANGER_RANGE()
{
	return m_iAI_TRANSPORT_DANGER_RANGE;
}

int CvGlobals::getAI_LOST_TRANSPORT_MEMORY_COUNT()
{
...
// R&R, ray, caching globals from Global Defines Alt - START
// Caching Vanilla variables	
int CvGlobals::getPLOT_VISIBILITY_RANGE()
{
	return m_PLOT_VISIBILITY_RANGE;
}
int CvGlobals::getUNIT_VISIBILITY_RANGE()
{
	return m_UNIT_VISIBILITY_RANGE;
}
int CvGlobals::getMIN_CITY_YIELD_DECAY()
{
	return m_MIN_CITY_YIELD_DECAY;
}
int CvGlobals::getCITY_YIELD_DECAY_PERCENT()
{
	return m_CITY_YIELD_DECAY_PERCENT;
}
int CvGlobals::getIMMIGRATION_THRESHOLD()
{
	return m_IMMIGRATION_THRESHOLD;
}
int CvGlobals::getIMMIGRATION_THRESHOLD_INCREASE()
{
	return m_IMMIGRATION_THRESHOLD_INCREASE;
}
int CvGlobals::getTAX_TRADE_THRESHOLD()
{
	return m_TAX_TRADE_THRESHOLD;
}
int CvGlobals::getTAX_TRADE_THRESHOLD_TAX_RATE_PERCENT()
{
	return m_TAX_TRADE_THRESHOLD_TAX_RATE_PERCENT;
}
int CvGlobals::getTAX_INCREASE_CHANCE()
{
	return m_TAX_INCREASE_CHANCE;
}
// TAC reduced REF
int CvGlobals::getENABLE_REDUCED_REF_FOR_AI()
{
	return m_ENABLE_REDUCED_REF_FOR_AI;
}
int CvGlobals::getREDUCED_REF_PERCENT()
{
	return m_REDUCED_REF_PERCENT;
}
// Domestic Market
int CvGlobals::getPRICE_DIFF_EUROPE_DOMESTIC_LUXURY_GOODS()
{
	return m_PRICE_DIFF_EUROPE_DOMESTIC_LUXURY_GOODS;
}
int CvGlobals::getDOMESTIC_SALES_MESSAGES()
{
	return m_DOMESTIC_SALES_MESSAGES;
}
// Wild Animals	

int CvGlobals::getWILD_ANIMAL_LAND_TERRAIN_NATIVE_WEIGHT()
{
	return m_WILD_ANIMAL_LAND_TERRAIN_NATIVE_WEIGHT;
}
int CvGlobals::getWILD_ANIMAL_LAND_UNIT_VARIATION_WEIGHT()
{
	return m_WILD_ANIMAL_LAND_UNIT_VARIATION_WEIGHT;
}
int CvGlobals::getWILD_ANIMAL_SEA_TERRAIN_NATIVE_WEIGHT()
{
	return m_WILD_ANIMAL_SEA_TERRAIN_NATIVE_WEIGHT;
}
int CvGlobals::getWILD_ANIMAL_SEA_UNIT_VARIATION_WEIGHT()
{
	return m_WILD_ANIMAL_SEA_UNIT_VARIATION_WEIGHT;
}
int CvGlobals::getWILD_ANIMAL_REWARD_RANDOM_BASE()
{
	return m_WILD_ANIMAL_REWARD_RANDOM_BASE;
}
// Max Cross Limit
int CvGlobals::getIMMIGRATION_MAX_CROSS_LIMIT()
{
	return m_IMMIGRATION_MAX_CROSS_LIMIT;
}
// NBMOD REF
int CvGlobals::getNBMOD_REF_ENABLE()
{
	return m_NBMOD_REF_ENABLE;
}
int CvGlobals::getNBMOD_REF_RANDOM_SHIPS()
{
	return m_NBMOD_REF_RANDOM_SHIPS;
}
int CvGlobals::getNBMOD_REF_REAL_WEAPONS()
{
	return m_NBMOD_REF_REAL_WEAPONS;
}
int CvGlobals::getNBMOD_REF_WEAPONS_BONUS()
{
	return m_NBMOD_REF_WEAPONS_BONUS;
}
int CvGlobals::getNBMOD_REF_REVOLUTION_PERCENT_ENABLE()
{
	return m_NBMOD_REF_REVOLUTION_PERCENT_ENABLE;
}
int CvGlobals::getNBMOD_REF_MAX_TAX_ENABLE()
{
	return m_NBMOD_REF_MAX_TAX_ENABLE;
}
int CvGlobals::getNBMOD_REF_WEAPONS_BONUS_PERCENT()
{
	return m_NBMOD_REF_WEAPONS_BONUS_PERCENT;
}
int CvGlobals::getNBMOD_REF_HORSES_BONUS_PERCENT()
{
	return m_NBMOD_REF_HORSES_BONUS_PERCENT;
}
float CvGlobals::getNBMOD_REF_WEAPONS_WEIGHT()
{
	return m_NBMOD_REF_WEAPONS_WEIGHT;
}
float CvGlobals::getNBMOD_REF_HORSES_WEIGHT()
{
	return m_NBMOD_REF_HORSES_WEIGHT;
}
int CvGlobals::getNBMOD_REF_NUM_UNITS_PERCENT()
{
	return m_NBMOD_REF_NUM_UNITS_PERCENT;
}
float CvGlobals::getNBMOD_REF_POPULATION_WEIGHT()
{
	return m_NBMOD_REF_POPULATION_WEIGHT;
}
float CvGlobals::getNBMOD_REF_TURN_WEIGHT()
{
	return m_NBMOD_REF_TURN_WEIGHT;
}
float CvGlobals::getNBMOD_REF_KING_PANIC_WEIGHT()
{
	return m_NBMOD_REF_KING_PANIC_WEIGHT;
}
int CvGlobals::getNBMOD_REF_START_VALUE_PERCENT()
{
	return m_NBMOD_REF_START_VALUE_PERCENT;
}
int CvGlobals::getNBMOD_REF_MAP_COEFFICIENT()
{
	return m_NBMOD_REF_MAP_COEFFICIENT;
}
int CvGlobals::getNBMOD_REF_DEBUG()
{
	return m_NBMOD_REF_DEBUG;
}
// NBMOD Education
int CvGlobals::getEDUCATION_THRESHOLD_INCREASE()
{
	return m_EDUCATION_THRESHOLD_INCREASE;
}
int CvGlobals::getEDUCATION_THRESHOLD()
{
	return m_EDUCATION_THRESHOLD;
}
// TAC Education
int CvGlobals::getUSE_TAC_EDUCATION_COST_SYSTEM()
{
	return m_USE_TAC_EDUCATION_COST_SYSTEM;
}
float CvGlobals::getTAC_EDUCATION_RANK1()
{
	return m_TAC_EDUCATION_RANK1;
}
float CvGlobals::getTAC_EDUCATION_RANK2()
{
	return m_TAC_EDUCATION_RANK2;
}
float CvGlobals::getTAC_EDUCATION_RANK3()
{
	return m_TAC_EDUCATION_RANK3;
}
// NBMod Tax
int CvGlobals::getMAX_TAX_RATE()
{
	return m_MAX_TAX_RATE;
}
int CvGlobals::getMIN_TAX_RATE()
{
	return m_MIN_TAX_RATE;
}
int CvGlobals::getINCREASE_MAX_TAX_RATE()
{
	return m_INCREASE_MAX_TAX_RATE;
}
int CvGlobals::getDECREASE_MAX_TAX_RATE()
{
	return m_DECREASE_MAX_TAX_RATE;
}
// TAC AI hurries Immigrants
int CvGlobals::getAI_HURRY_IMMIGRANTS()
{
	return m_AI_HURRY_IMMIGRANTS;
}
// TAC LbD
int CvGlobals::getLBD_BASE_CHANCE_EXPERT()
{
	return m_LBD_BASE_CHANCE_EXPERT;
}
int CvGlobals::getLBD_CHANCE_INCREASE_EXPERT()
{
	return m_LBD_CHANCE_INCREASE_EXPERT;
}
int CvGlobals::getLBD_PRE_ROUNDS_EXPERT()
{
	return m_LBD_PRE_ROUNDS_EXPERT;
}
int CvGlobals::getLBD_KI_MOD_EXPERT()
{
	return m_LBD_KI_MOD_EXPERT;
}
int CvGlobals::getLBD_BASE_CHANCE_FREE()
{
	return m_LBD_BASE_CHANCE_FREE;
}
int CvGlobals::getLBD_CHANCE_INCREASE_FREE()
{
	return m_LBD_CHANCE_INCREASE_FREE;
}
int CvGlobals::getLBD_PRE_ROUNDS_FREE()
{
	return m_LBD_PRE_ROUNDS_FREE;
}
int CvGlobals::getLBD_CHANCE_MOD_FREE_CRIMINAL()
{
	return m_LBD_CHANCE_MOD_FREE_CRIMINAL;
}
int CvGlobals::getLBD_CHANCE_MOD_FREE_SERVANT()
{
	return m_LBD_CHANCE_MOD_FREE_SERVANT;
}
int CvGlobals::getLBD_CHANCE_ESCAPE()
{
	return m_LBD_CHANCE_ESCAPE;
}
int CvGlobals::getLBD_CHANCE_MOD_ESCAPE_CRIMINAL()
{
	return m_LBD_CHANCE_MOD_ESCAPE_CRIMINAL;
}
int CvGlobals::getLBD_CHANCE_MOD_ESCAPE_SERVANT()
{
	return m_LBD_CHANCE_MOD_ESCAPE_SERVANT;
}
// TAC price diff raw to produced
int CvGlobals::getPRICE_DIFF_MAN_TO_RAW()
{
	return m_PRICE_DIFF_MAN_TO_RAW;
}
// TAC KI patch
int CvGlobals::getAI_REBELS_FOR_REVOLUTION()
{
	return m_AI_REBELS_FOR_REVOLUTION;
}
int CvGlobals::getUNIT_REVOLUTION_RATIO()
{
	return m_UNIT_REVOLUTION_RATIO;
}
int CvGlobals::getAI_FREE_CITY_DEFENDERS()
{
	return m_AI_FREE_CITY_DEFENDERS;
}
// TAC capturing Ships
int CvGlobals::getBASE_CHANCE_CAPTURING_SHIPS()
{
	return m_BASE_CHANCE_CAPTURING_SHIPS;
}
// Min Rounds and Base Chances for DLL-Diplo-Events
int CvGlobals::getMIN_ROUND_NATIVE_MERCS()
{
	return m_MIN_ROUND_NATIVE_MERCS;
}
int CvGlobals::getMIN_ROUND_EUROPE_WARS()
{
	return m_MIN_ROUND_EUROPE_WARS;
}
int CvGlobals::getBASE_CHANCE_EUROPE_WARS()
{
	return m_BASE_CHANCE_EUROPE_WARS;
}
int CvGlobals::getBASE_CHANCE_EUROPE_PEACE()
{
	return m_BASE_CHANCE_EUROPE_PEACE;
}
int CvGlobals::getMIN_ROUND_PRISONS_CROWDED()
{
	return m_MIN_ROUND_PRISONS_CROWDED;
}
int CvGlobals::getPRISONS_CROWDED_CHANCE()
{
	return m_PRISONS_CROWDED_CHANCE;
}
int CvGlobals::getMIN_ROUND_REVOLUTIONARY_NOBLE()
{
	return m_MIN_ROUND_REVOLUTIONARY_NOBLE;
}
int CvGlobals::getREVOLUTIONARY_NOBLE_CHANCE()
{
	return m_REVOLUTIONARY_NOBLE_CHANCE;
}
int CvGlobals::getMIN_ROUND_SMUGGLERS_AVAILABLE()
{
	return m_MIN_ROUND_SMUGGLERS_AVAILABLE;
}
int CvGlobals::getBASE_CHANCE_SMUGGLERS_AVAILABLE()
{
	return m_BASE_CHANCE_SMUGGLERS_AVAILABLE;
}
int CvGlobals::getMIN_ROUND_PIRATES()
{
	return m_MIN_ROUND_PIRATES;
}
int CvGlobals::getBASE_CHANCE_PIRATES()
{
	return m_BASE_CHANCE_PIRATES;
}
int CvGlobals::getBASE_CHANCE_RANGERS_AVAILABLE()
{
	return m_BASE_CHANCE_RANGERS_AVAILABLE;
}
int CvGlobals::getBASE_CHANCE_CONQUISTADORS_AVAILABLE()
{
	return m_BASE_CHANCE_CONQUISTADORS_AVAILABLE;
}
int CvGlobals::getMIN_ROUND_NATIVE_SLAVE()
{
	return m_MIN_ROUND_NATIVE_SLAVE;
}
int CvGlobals::getMIN_ROUND_AFRICAN_SLAVES()
{
	return m_MIN_ROUND_AFRICAN_SLAVES;
}
int CvGlobals::getAFRICAN_SLAVES_CHANCE()
{
	return m_AFRICAN_SLAVES_CHANCE;
}
int CvGlobals::getMIN_ROUND_BISHOP()
{
	return m_MIN_ROUND_BISHOP;
}
int CvGlobals::getBISHOP_CHANCE()
{
	return m_BISHOP_CHANCE;
}
// Timers for DLL-Diplo-Events
int CvGlobals::getTIMER_NATIVE_MERC()
{
	return m_TIMER_NATIVE_MERC;
}
int CvGlobals::getTIMER_EUROPEAN_WARS()
{
	return m_TIMER_EUROPEAN_WARS;
}
int CvGlobals::getTIMER_EUROPEAN_PEACE()
{
	return m_TIMER_EUROPEAN_PEACE;
}
int CvGlobals::getTIMER_PRISONS_CROWDED()
{
	return m_TIMER_PRISONS_CROWDED;
}
int CvGlobals::getTIMER_REVOLUTIONARY_NOBLE()
{
	return m_TIMER_REVOLUTIONARY_NOBLE;
}
int CvGlobals::getTIMER_BISHOP()
{
	return m_TIMER_BISHOP;
}
int CvGlobals::getTIMER_SMUGGLING_SHIP()
{
	return m_TIMER_SMUGGLING_SHIP;
}
int CvGlobals::getTIMER_PIRATES()
{
	return m_TIMER_PIRATES;
}
int CvGlobals::getTIMER_CONTINENTAL_GUARD()
{
	return m_TIMER_CONTINENTAL_GUARD;
}

int CvGlobals::getTIMER_MORTAR()
{
	return m_TIMER_MORTAR;
}

int CvGlobals::getTIMER_RANGER()
{
	return m_TIMER_RANGER;
}
int CvGlobals::getTIMER_CONQUISTADOR()
{
	return m_TIMER_CONQUISTADOR;
}
int CvGlobals::getTIMER_NATIVE_SLAVE()
{
	return m_TIMER_NATIVE_SLAVE;
}
int CvGlobals::getTIMER_AFRICAN_SLAVE()
{
	return m_TIMER_AFRICAN_SLAVE;
}
// Native Raids
int CvGlobals::getNATIVE_POTENTIAL_RAID_TARGET_THRESHOLD()
{
	return m_NATIVE_POTENTIAL_RAID_TARGET_THRESHOLD;
}
int CvGlobals::getNATIVE_GOODS_RAID_PERCENT()
{
	return m_NATIVE_GOODS_RAID_PERCENT;
}
int CvGlobals::getRANDOM_NATIVE_RAID_BASECHANCE()
{
	return m_RANDOM_NATIVE_RAID_BASECHANCE;
}
int CvGlobals::getNATIVE_SPARE_AI_TREASURE_CHANCE()
{
	return m_NATIVE_SPARE_AI_TREASURE_CHANCE;
}
// Roundwise Native Income
int CvGlobals::getPER_ROUND_PER_VILLAGE_INCOME_MAX()
{
	return m_PER_ROUND_PER_VILLAGE_INCOME_MAX;
}
int CvGlobals::getPER_VILLAGE_FEATURE_GENERATION_LIMIT()
{
	return m_PER_VILLAGE_FEATURE_GENERATION_LIMIT;
}
// New Storage
int CvGlobals::getCUSTOMHOUSE_STRATEGIC_RAW_SELL_THRESHOLD()
{
	return m_CUSTOMHOUSE_STRATEGIC_RAW_SELL_THRESHOLD;
}
int CvGlobals::getCUSTOMHOUSE_STRATEGIC_PRODUCED_SELL_THRESHOLD()
{
	return m_CUSTOMHOUSE_STRATEGIC_PRODUCED_SELL_THRESHOLD;
}
int CvGlobals::getCUSTOMHOUSE_RAW_SELL_THRESHOLD()
{
	return m_CUSTOMHOUSE_RAW_SELL_THRESHOLD;
}
int CvGlobals::getCUSTOMHOUSE_PRODUCED_SELL_THRESHOLD()
{
	return m_CUSTOMHOUSE_PRODUCED_SELL_THRESHOLD;
}
// Improvement TAX mechanism
int CvGlobals::getTAX_TRADE_INCREASE_CHANCE_KING_ATTITUDE_BASE()
{
	return m_TAX_TRADE_INCREASE_CHANCE_KING_ATTITUDE_BASE;
}
// New Rules for Profession Missionary
int CvGlobals::getUSE_NEW_RULES_FOR_PROFESSION_MISSIONARY()
{
